 ...
 * Weighted KNN using gaussian function as defaust weight function
  * 3 weight methods, based on "the weight declines when the distance increases"
   ...
   * Subtraction Weight function: won't overweight close items, but the weight will finally drop to 0, in some cases this cannot help make prediction at all, since there is nothing close enough to be ocnsidered as neighbors
