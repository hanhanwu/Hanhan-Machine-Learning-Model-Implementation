...
* In order to acieve the ranking, I am using some methods to calculate the scores
  ...
  Method 2 - Checking words location, the earlier, score higher. Assuming most of the major topics or important content will appear near the top of the page. Here, the whole row of the sqlite records will be used, row[0] is the url id while other columns in a row indicates the locations of those query words appeared on the same page.
