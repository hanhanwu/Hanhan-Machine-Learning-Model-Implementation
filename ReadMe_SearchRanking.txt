 ...
 * In my code, I will just use 1 hiden layer. The input layer is query words, the output layer is a list of weightings for returned URLs. The connections betwwen nodes in different layers will be built only when necessary.
 ...
 * backpropagate
 ...
 Finally, connect the neural network with the search engine, in crawler_and_searcher.py
